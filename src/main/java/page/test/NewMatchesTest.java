...
public class NewMatchesTest extends BasePageActions {
	...
	@Test(priority = 0, description = "Navigate to New Matches tab")
	...
	@Test(priority = 1, description = "Verify refine button on New matches tab")
	...
	@Test(priority = 5, description = "Verify dropdown options on New matches listing")
	...
	@Test(priority = 6, description = "Verify connect now on profile on New matches listing tab")
	...
	@Test(priority = 7, description = "Verify view contact on profile on New matches listing tab")
	...
	@Test(priority = 8, description = "Verify connect now on profile from profile page")
	...
	@Test(priority = 9, description = "Verify view contact on profile from profile page")
